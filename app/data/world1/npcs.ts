...
// SLICES/ZONES). Sprites are 48×32-frame idle sheets; the scene shows frame 0 with a gentle bob.
...
export const TOWN_NPCS: TownNpc[] = [
  { id: 'guildmaster', name: 'Mara', title: 'Guildmaster', sprite: 'npc-sprites/guildmaster.png', frameW: 48, frameH: 32, at: [1150, 250] },
  { id: 'portal_guardian', name: 'Kael', title: 'Portal Guardian', sprite: 'npc-sprites/portal_guardian.png', frameW: 48, frameH: 32, at: [737, 250] },
  { id: 'blacksmith', name: 'Borin', title: 'Blacksmith', sprite: 'npc-sprites/blacksmith.png', frameW: 48, frameH: 32, at: [1255, 505] },
  { id: 'forest_ranger', name: 'Wren', title: 'Forest Ranger', sprite: 'npc-sprites/forest_ranger.png', frameW: 48, frameH: 32, at: [470, 560] },
]
